...
<body>
	<div class="ms-auto p-2">
		<div class="ms-auto p-2">
			...
			<button type="button" class="btn btn-outline-success" onclick="location.href='./Cuenta/MisPublicaciones';">
			...
			<% if (usuario.getTipo() == DefaultEnumInteger.ADMINISTRADOR.getValue()) {%>
				<button type="button" class="btn btn-outline-success" onclick="location.href='./Cuenta/Admin';">
	...
	<div class="form-row"><br><br><br></div>
	...
	<div class="container d-flex align-items-center justify-content-center">
			<div class="form-group col-md-6">
				<div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="<%=usuario.getEmail()%>" readonly>
                </div>
                <br>
                <div class="form-group">
                ...
                <div class="text-center">
                	<button type="button" class="btn btn-outline-primary" onclick="location.href='./Cuenta/ChangePassword';">Cambiar contraseña</button><br><br>
                </div>
                <div class="text-center">
