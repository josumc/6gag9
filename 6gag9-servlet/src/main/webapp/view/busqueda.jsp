...
<%
	...
	PublicacionImage publicacion = (PublicacionImage) request.getSession().getAttribute("publicacion");
...
<body>
    ...
    <% } else { %>
    	<div class="form-row"><br><br><br><br><br></div>
	                    ...
	                    <div class="d-flex">
	                        <div class="p-2">
	                        	<% if(usuario != null) { %>	
	                            	...
	                            	<input type="text" hidden class="hidden" name="id_like" value="<%= publicacion.getId_like()%>">
	                            	<input type="text" hidden class="hidden" name="method_like" value="si">
	                        	<%} else { %>
	                        		<button type="submit" class="btn btn-light">
	                            	...
	                            	<input type="text" hidden class="hidden" name="method_like" value="no">
	                            <%} %>
	                            <input type="text" hidden name="id_publicacion" class="hidden" value="<%=publicacion.getId_publicacion()%>"/>
	                        </div>
	                        	<%} %>
	                    </div>
