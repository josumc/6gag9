...
A la hora de iniciar el despliegue en caso de dar un error tenemos que abrir el properties del proyecto y en target runtimes debemos añadir un server propio, en la seccion ui-statics marca un fallo pero debemos omitirla.
